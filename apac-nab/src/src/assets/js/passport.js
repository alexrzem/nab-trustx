...
// passport for AU, else foreignPassport
...
var dispatchData = ()=> {
    ...
    if(Object.keys(source).length > 0){
        ...
        if(selectedDocumentType === "foreignPassport"){
...
var subscribe = (event) => {
    ...
    if(trustXData.variables.sessionData.selectedDocumentType != undefined){
        selectedDocumentType = trustXData.variables.sessionData.selectedDocumentType;
    }
